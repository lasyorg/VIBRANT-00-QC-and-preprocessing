...
mgh_arm_data <- 
  ...
  mutate(
    ...
    arm = case_when(
      TREATMENT == "LC-106 daily for 7d after metronidazole treatment" ~ "LC106-7",
      TREATMENT == "LC-106 daily for 3d + 4 d of placebo, starting after metronidazole treatment" ~ "LC106-3",
      TREATMENT == "LC-106 daily for 7d, starting on day 3 of metronidazole treatment" ~ "LC106-o",
      TREATMENT == "LC-115 daily for 7d after metronidazole treatment" ~ "LC115",
...
cap_arm_data <- 
  ...
  mutate(
    ...
    arm = case_when(
      TREATMENT_NAME == "LC-106 daily for 7d after metronidazole treatment" ~ "LC106-7",
      TREATMENT_NAME == "LC-106 daily for 3d + 4 d of placebo, starting after metronidazole treatment" ~ "LC106-3",
      TREATMENT_NAME == "LC-106 daily for 7d, starting on day 3 of metronidazole treatment" ~ "LC106-o",
      TREATMENT_NAME == "LC-115 daily for 7d after metronidazole treatment" ~ "LC115",
...
all(mgh_arm_data$arm[mgh_arm_data$group4 == "Yes"] == "LC106-o", na.rm = TRUE)
all(cap_arm_data$arm[cap_arm_data$group4 == "Yes"] == "LC106-o", na.rm = TRUE)

...
mgh_arm_data <-
  ...
  mutate(
    ...
    arm = case_when(
      ...
      TREATMENT ==
        "LC-106 daily for 3d + 4 d of placebo, starting after metronidazole treatment" ~ "LC106-3",
  ...
  mutate(
    ...
    arm = case_when(
      ...
      TREATMENT_NAME ==
        "LC-106 daily for 3d + 4 d of placebo, starting after metronidazole treatment" ~ "LC106-3",
      TREATMENT_NAME ==
        "LC-106 daily for 7d, starting on day 3 of metronidazole treatment" ~ "LC106-o",
      TREATMENT_NAME == "LC-115 daily for 7d after metronidazole treatment" ~ "LC115",
      TREATMENT_NAME ==
        "Placebo daily for 7d after metronidazole treatment (Control for LC-106)" ~ "Pl",
      TRUE ~ NA_character_
    )
  ) |>
  left_join(

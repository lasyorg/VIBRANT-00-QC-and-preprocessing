...
crf31_sub <- 
  ...
  filter(str_detect(medication, regex("METRONIDAZOLE|FLAGYL|FOSFOMYCIN|CIPROFLOXACIN|NITROFURANTOIN|CIPROBAY|MACROBID|AZITHROMYCIN|PENICILLIN|AMOXICILLIN|AUGMENTIN|CIPROFLOXACIN|CEFTRIAXONE|DOXYCYCLINE|BENZANINE", ignore_case = TRUE))) |>
  ...
  mutate(
    description = 
      case_when(
        ...
        variable == "any_antibiotics_crf31" ~ "Whether participant used any antibiotics before visit 1500 according to CRF31 (concomitant medications).",
